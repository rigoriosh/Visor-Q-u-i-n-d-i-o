...
SelectableLayerItem, FeatureItem) {
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    startup : function (){
      $('#widgets_Select_Widget_47_panel').find(".title").find(".close-icon").after('<div class = "help-icon jimu-float-trailing" title = "Esta funcionalidad realiza una selecci&oacute;n espacial de las capas agregadas"></div>');
    },
