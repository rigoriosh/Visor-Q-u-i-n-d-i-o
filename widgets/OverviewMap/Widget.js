  ...
  function(
    ...
    var clazz = declare([BaseWidget], {
      ...
      createOverviewMap: function(visible) {
        ...
        json.width = 200;
        json.height = 200;
        json.expandFactor = -100000000000000000;
        ...
        console.log(this.overviewMapDijit);
      ...
      onOpen: function() {
        this._destroyOverviewMap();
        this.createOverviewMap(this._showDijit);
       // console.log(this.overviewMapDijit.base)
          /*
        var muni = "http://132.255.20.158:6080/arcgis/rest/services/QUINDIO_III/CartografiaBasica/MapServer/15";
        var featureLayer = new FeatureLayer(muni, { outFields: ["*"] });
        this.overviewMapDijit.map.addLayer(featureLayer);
        */


        var limite = "http://190.85.164.30:6080/arcgis/rest/services/QUINDIO_III/CartografiaBasica/MapServer/15";
        var featureLayer = new FeatureLayer(limite, { outFields: ["*"] });
          // this.overviewMapDijit.map.addLayer(featureLayer);
/*
        console.log("this.overviewMapDijit antes");
        console.log(this.overviewMapDijit);
        this.overviewMapDijit.map.addLayer(featureLayer);

        console.log("this.overviewMapDijit despues");
        console.log(this.overviewMapDijit);
        */
      },
