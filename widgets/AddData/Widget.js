  ...
  function(declare, lang, on, aspect, Deferred, domClass, portalUrlUtils, portalUtils,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        $('#widgets_AddData_Widget_43_panel').find(".title").find(".close-icon").after('<div class = "help-icon jimu-float-trailing" title = "Esta funcionalidad permite agregar capas a partir de archivos o url"></div>');
