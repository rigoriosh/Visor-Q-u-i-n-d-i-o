        ...
        return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
            ...
            _generateFeatures: function(job, formData) {
                ...
                if (job.generalize) {
                    ...
                    params.generalize = false; //modificación de true a false el 15/10/2019 para evitar generalización shapefile
                    ...
                    params.reducePrecision = false; //modificación de true a false el 15/10/2019 para evitar generalización shapefile
