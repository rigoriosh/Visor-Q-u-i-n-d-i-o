...
_WidgetsInTemplateMixin, BaseWidget, LayerInfos, Legend) {
  ...
  var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    startup: function() {
      ...
      $('#widgets_Legend_Widget_18_panel').find(".title").find(".close-icon").after('<div class = "help-icon jimu-float-trailing" title = "Esta funcionalidad muestra la leyenda de las capas agregadas al mapa"></div>');
    },
