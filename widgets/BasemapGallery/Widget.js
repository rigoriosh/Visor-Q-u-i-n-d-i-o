  ...
  function(
    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        $('#widgets_BasemapGallery_Widget_42_panel').find(".title").find(".close-icon").after('<div class = "help-icon jimu-float-trailing" title = "Esta funcionalidad permite cambiar el mapa base"></div>');
      },
