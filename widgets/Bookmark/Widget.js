...
function(declare, lang, array, html, BaseWidget, on, aspect, string,
  ...
  return declare([BaseWidget], {
    ...
    startup: function(){
      ...
      $('#widgets_Bookmark_Widget_51_panel').find(".title").find(".close-icon").after('<div class = "help-icon jimu-float-trailing" title = "Funcionalidad para almacenar vistas del mapa"></div>');
      // summary:
