            ...
            if(!e.icon){
              if(e.widgets[0].uri){
                e.icon = this._getDefaultIconFromUri(e.widgets[0].uri);
                  ...
                  e.icon = 'jimu.js/images/carpeta-consultas.png';
              }
            }
          }else{
              ...
              if (e.label == "Consultas") {

                  e.icon ='jimu.js/images/carpeta-consultas.png';


              } else if (e.label == "Espaciales") {
                  e.icon = 'jimu.js/images/carpeta-espaciales.png';

                  //e.icon = e.icon ? e.icon : 'jimu.js/images/carpeta-espaciales.png';
              }
          }
        }else{
          e.gid = info.groupId;
